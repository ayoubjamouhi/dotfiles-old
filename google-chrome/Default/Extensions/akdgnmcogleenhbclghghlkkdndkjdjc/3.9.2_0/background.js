...
var Analytics = function () {
  ...
  _createClass(Analytics, [{
    ...
    value: function sendRequest(data) {
      ...
      request += '&cs=' + encodeURIComponent('3.9.2') + '&cm=chrome&ds=' + encodeURIComponent('3.9.2');
...
var SemrushClient = function () {
  ...
  _createClass(SemrushClient, [{
    ...
    value: function requestTrafficAnalytics(callback, q, s) {
      ...
      this._queue.push({
        url: function url() {
          return SemrushClient.URL_TRAFFIC_ANALYTICS + '?domain=' + encodeURIComponent(q) + (s ? '&scope=' + s : '') + '&access_token=' + _this14._token;
        },
        type: 'get',
        resolve: function resolve(answer) {
