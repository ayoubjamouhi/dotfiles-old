...
},{"timers":12}],7:[function(require,module,exports){
...
var utils = require('./utils.es6'); // Return Sec-GPC header if setting enabled
...
function injectDOMSignal(tabId, frameId) {
  ...
  var contentScriptName = browserName === 'moz' ? 'GPC-moz.js' : 'GPC.js'; // first pass GPC value to frames

  chrome.tabs.executeScript(tabId, {
    code: "\n            try {\n                var globalPrivacyControlValue = ".concat(GPCEnabled, "\n            } catch(e) {}"),
...
},{"./settings.es6":40,"./utils.es6":47}],19:[function(require,module,exports){
"use strict";
...
},{"../shared-utils/parse-user-agent-string.es6":48,"./chrome-wrapper.es6":23,"./load.es6":34,"./settings.es6":40}],21:[function(require,module,exports){
"use strict";
...
},{"./chrome-events.es6":22,"./settings.es6":40}],22:[function(require,module,exports){
"use strict";
...
function blockingExperimentActive() {
  ...
  if (activeExperiment) {
    ...
    return _experiment && _experiment.blockingActivated;
  } // return false
...
var browserWrapper = require('./chrome-wrapper.es6'); // handle any messages that come from content/UI scripts
...
chrome.runtime.onMessage.addListener(function (req, sender, res) {
  ...
  if (req.checkThirdParty) {
    ...
    if (blockingExperimentActive()) {
      ...
      if (_tab && _tab.site.whitelisted) {
        res(action);
        return true;
      } // determine the register domain of the sending tab


      var tabUrl = _tab ? _tab.url : sender.tab.url;
...
function getContentScope() {
  return _getContentScope.apply(this, arguments);
}

function _getContentScope() {
  _getContentScope = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var url, response;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            url = chrome.runtime.getURL('/public/js/content-scope.js');
            _context4.next = 3;
            return fetch(url);
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            contentScopeScript = _context5.sent;
            ...
            chrome.webNavigation.onCommitted.addListener(function (details) {
              ...
              if (tab && tab.site.isBroken) {
                console.log('temporarily skip fingerprint protection for site: ' + details.url + 'more info: https://github.com/duckduckgo/content-blocking-whitelist');
                return;
              }
              ...
              if (tab && !tab.site.whitelisted) {
                ...
                try {
                  ...
                  var variableScript = {
                    code: "\n                      try {\n                          var ddg_args = ".concat(JSON.stringify(argumentsObject), "\n                      } catch(e) {}"),
                    runAt: 'document_start',
                    frameId: details.frameId,
                    matchAboutBlank: true
                  };
                  ...
                  console.log("Failed to inject fingerprint protection into ".concat(details.url, ": ").concat(e));
                }
              }
            });
...
var GPC = require('./GPC.es6'); // Set GPC property on DOM if enabled.
...
},{"../../data/constants":14,"../shared-utils/sha1":49,"./../background/storage/cookies.es6":41,"./GPC.es6":18,"./atb.es6":20,"./chrome-wrapper.es6":23,"./companies.es6":30,"./experiments.es6":31,"./https-service.es6":32,"./https.es6":33,"./onboarding.es6":36,"./pixel.es6":37,"./redirect.es6":39,"./settings.es6":40,"./storage/https.es6":42,"./storage/tds.es6":43,"./tab-manager.es6":44,"./tracker-utils":45,"./trackers.es6":46,"./utils.es6":47,"regenerator-runtime/runtime":11,"tldts":13}],23:[function(require,module,exports){
"use strict";
...
},{"../../../data/constants":14,"../pixel.es6":37,"../utils.es6":47}],26:[function(require,module,exports){
"use strict";
...
},{"../chrome-wrapper.es6":23,"../privacy-practices.es6":38,"../settings.es6":40,"../utils.es6":47,"./../storage/tds.es6":43,"@duckduckgo/privacy-grade":1}],27:[function(require,module,exports){
"use strict";
...
},{"../companies.es6":30,"../storage/tds.es6":43}],30:[function(require,module,exports){
"use strict";
...
},{"../../data/experiments-out":16,"./atb-utils.es6":19,"./settings.es6":40}],32:[function(require,module,exports){
"use strict";
...
},{"../../data/constants":14,"../shared-utils/sha1":49,"punycode":10}],33:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
...
},{"./chrome-wrapper.es6":23,"./https-service.es6":32,"./pixel.es6":37,"./settings.es6":40,"./tab-manager.es6":44,"./utils.es6":47,"buffer":5,"jsbloom":8,"tldts":13}],34:[function(require,module,exports){
"use strict";
...
},{"../shared-utils/parse-user-agent-string.es6":48,"./chrome-wrapper.es6":23,"./load.es6":34,"./settings.es6":40}],38:[function(require,module,exports){
"use strict";
...
},{"../../data/constants":14,"../../data/tosdr":17,"./utils.es6":47,"tldts":13}],39:[function(require,module,exports){
"use strict";
...
var webResourceURL = browserWrapper.getExtensionURL('/web_accessible_resources');
var browser = utils.getBrowserName();
...
function handleRequest(requestData) {
  ...
  if (requestData.type === 'main_frame' && window.chrome) {
    ...
    var tracker = trackers.getTrackerData(requestData.url, thisTab.site.url, requestData); // allow embedded twitter content if user enabled this setting
...
},{"./atb.es6":20,"./chrome-wrapper.es6":23,"./companies.es6":30,"./https.es6":33,"./settings.es6":40,"./tab-manager.es6":44,"./trackers.es6":46,"./utils.es6":47,"tldts":13}],40:[function(require,module,exports){
"use strict";
...
},{"../../data/defaultSettings":15,"./chrome-wrapper.es6":23}],41:[function(require,module,exports){
"use strict";
...
},{"../../../data/constants":14,"./../load.es6":34,"./../settings.es6":40,"regenerator-runtime/runtime":11}],42:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
...
},{"../../../data/constants":14,"./../load.es6":34,"./../settings.es6":40,"buffer":5,"dexie":6}],43:[function(require,module,exports){
"use strict";
...
},{"../../../data/constants":14,"./../chrome-wrapper.es6":23,"./../load.es6":34,"./../settings.es6":40,"dexie":6}],44:[function(require,module,exports){
"use strict";
...
},{"./chrome-wrapper.es6":23,"./classes/tab.es6":27,"./companies.es6":30,"./settings.es6":40}],45:[function(require,module,exports){
"use strict";
...
var tdsStorage = require('./storage/tds.es6'); // Determine if two URL's belong to the same entity.
...
},{"./storage/tds.es6":43,"./trackers.es6":46,"./utils.es6":47,"tldts":13}],46:[function(require,module,exports){
"use strict";
...
},{"./utils.es6":47,"@duckduckgo/privacy-grade":1,"tldts":13}],47:[function(require,module,exports){
"use strict";
...
function getBrokenFeatures(url) {
  if (!(tdsStorage !== null && tdsStorage !== void 0 && tdsStorage.fingerprinting)) return;
  var brokenFeatures = [];

  for (var feature in tdsStorage.fingerprinting) {
    var _tdsStorage$fingerpri;

    if (!((_tdsStorage$fingerpri = tdsStorage.fingerprinting[feature]) !== null && _tdsStorage$fingerpri !== void 0 && _tdsStorage$fingerpri.enabled)) {
...
function getBrokenScriptLists() {
  ...
  for (var key in tdsStorage === null || tdsStorage === void 0 ? void 0 : tdsStorage.fingerprinting) {
    var _tdsStorage$fingerpri2;

    brokenScripts[key] = ((_tdsStorage$fingerpri2 = tdsStorage.fingerprinting[key]) === null || _tdsStorage$fingerpri2 === void 0 ? void 0 : _tdsStorage$fingerpri2.scripts) || [];
  }
...
},{"../../data/constants":14,"../shared-utils/parse-user-agent-string.es6":48,"./settings.es6":40,"./storage/tds.es6":43,"tldts":13}],48:[function(require,module,exports){
"use strict";
